...
PROJECT := DISCO_L475VG_IOT01-wifi-client
...
OBJECTS += DISCO_L475VG_IOT01A_wifi/es_wifi.o
OBJECTS += DISCO_L475VG_IOT01A_wifi/es_wifi_io.o
OBJECTS += DISCO_L475VG_IOT01A_wifi/wifi.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../DISCO_L475VG_IOT01A_wifi
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1525246021.42
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1525246021.42
...
ASM_FLAGS += -I../.
ASM_FLAGS += -I../DISCO_L475VG_IOT01A_wifi
ASM_FLAGS += -I../mbed-os/.
