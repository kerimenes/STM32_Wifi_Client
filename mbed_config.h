...
#define MBED_CONF_APP_SERVER_IP_2                      168         // set by application
#define MBED_CONF_APP_SERVER_IP_3                      1           // set by application
#define MBED_CONF_APP_SERVER_IP_1                      192         // set by application
#define MBED_CONF_DRIVERS_UART_SERIAL_RXBUF_SIZE       256         // set by library:drivers
#define MBED_CONF_APP_SERVER_IP_4                      101         // set by application
